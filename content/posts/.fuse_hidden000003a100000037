...
_publicize_job_id: "43819012282"
author: gmirchev90
categories:
  - android
  - code-architecture
date: "2020-05-04T10:32:29+00:00"
guid: http://georgimirchev.com/?p=100
parent_post_id: null
post_id: "100"
summary: Do you still use it!? Have you used it? I mean the EventBus. If the answer is **NO**, then you are either a new developer who started Android recently or you had the wonderful opportunity to not meet this three-headed monster. What I am talking about? Let’s make a brieft visit of the Android development history.
tags:
  - eventbus
  - events
timeline_notification: "1588588350"
title: It’s 21st century – Stop using EVENTBUS!
url: /2020/05/04/its-21st-century-stop-using-eventbus/
...
At the beginning of my career there was [RoboSp](https://web.archive.org/web/20190903205344/https://github.com/stephanenicolas/robospice) [i](https://github.com/stephanenicolas/robospice) [ce](https://web.archive.org/web/20190903205344/https://github.com/stephanenicolas/robospice). If you don’t know, RoboSpice uses a background service to execute the network requests and then delivers them back to the main thread using callbacks.
...
– Google was quiet as shit. There was [one lecture](http://www.youtube.com/watch?v=xHXn3Kg2IQE) about application architecture and it was so complicated that noone would bother using it  
